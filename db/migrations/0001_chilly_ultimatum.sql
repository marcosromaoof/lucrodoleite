...
ALTER TABLE "users" ALTER COLUMN "email_verified" SET DATA TYPE timestamp with time zone USING CASE WHEN "email_verified" = true THEN now() ELSE NULL END;--> statement-breakpoint
